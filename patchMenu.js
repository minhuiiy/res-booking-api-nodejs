...
// 1. Create Menus.jsx
fs.writeFileSync(path.join(__dirname, 'frontend/src/pages/Menus.jsx'), `import { useState, useEffect, useContext } from 'react';
...
// 2. Update App.jsx to include Menus Page
let appContent = fs.readFileSync(path.join(__dirname, 'frontend/src/App.jsx'), 'utf8');

// Insert import
if(!appContent.includes('import Menus')) {
...
// Insert route
if(!appContent.includes('<Route path="menus" element={<Menus />} />')) {
    appContent = appContent.replace(
...
fs.writeFileSync(path.join(__dirname, 'frontend/src/App.jsx'), appContent);

console.log('Menu feature added!');
