...
module.exports = mongoose.model('User', userSchema);""",
    ...
    "src/models/Restaurant.js": """const mongoose = require('mongoose');
...
module.exports = mongoose.model('Restaurant', restaurantSchema);""",
    ...
    "src/models/Table.js": """const mongoose = require('mongoose');
...
module.exports = mongoose.model('Table', tableSchema);""",
    ...
    "src/models/Category.js": """const mongoose = require('mongoose');
...
module.exports = mongoose.model('Category', categorySchema);""",
    ...
    "src/models/MenuItem.js": """const mongoose = require('mongoose');
...
module.exports = mongoose.model('MenuItem', menuItemSchema);""",
    ...
    "src/models/Reservation.js": """const mongoose = require('mongoose');
...
module.exports = mongoose.model('Reservation', reservationSchema);""",
    ...
    "src/models/Review.js": """const mongoose = require('mongoose');
...
module.exports = mongoose.model('Review', reviewSchema);""",
    ...
    "src/models/Payment.js": """const mongoose = require('mongoose');
...
models = ['Restaurant', 'Table', 'Category', 'MenuItem', 'Reservation', 'Review', 'Payment']

for model in models:
    lowerModel = model[0].lower() + model[1:]
    
    files[f"src/controllers/{lowerModel}Controller.js"] = f"""const {model} = require('../models/{model}');
...
exports.delete{model} = async (req, res) => {{
    try {{
        ...
        if (document) res.json({{ message: '{model} removed' }});
        else res.status(404).json({{ message: '{model} not found' }});
    }} catch (error) {{ res.status(500).json({{ message: error.message }}); }}
}};
"""

    files[f"src/routes/{lowerModel}Routes.js"] = f"""const express = require('express');
const router = express.Router();
